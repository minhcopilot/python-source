...
from app.services.user import get_list_users,create,get_all,get_user_by_id,update,delete
...
async def update_user(id: int, data: str, db: Session = Depends(get_db)):
