...
from app.services.auth import login,get_refresh_token,register,verified_user,verified_email,reset_password_user,forgot_password_user,login_google,google_callback
...
async def forgot_password(email):
    return await forgot_password_user(email)
